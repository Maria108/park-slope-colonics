...
const HomePage = () => (
  <Layout>
    ...
    <section
      className="relative min-h-[70vh] h-full sm:mx-20 mb-20 bg-cover bg-left-top flex sm:flex-row items-stretch"
      style={{
        backgroundImage: `url(${me})`,
      }}
    >
      {/* Left Section - Text */}
      <div className="w-full sm:w-[40%] bg-white bg-opacity-70 p-6 sm:p-12 flex flex-col justify-center">
        ...
        <p className="text-sm sm:text-base md:text-lg font-bold mb-4">
          One Colonic Session (45-60 mins) - $150
        </p>
        <a
          href="https://square-link"
          target="_blank"
          rel="noopener noreferrer"
          className="bg-customDarkGreen text-white px-6 py-3 rounded-md hover:bg-customBeige inline-block"
        >
          Book an Appointment
        </a>
      </div>
      ...
      {/* Right Section - Slogan */}
      <div
        className="w-full sm:w-[60%] bg-cover bg-center p-6 sm:p-12 text-customDarkGreen flex justify-center items-center flex-grow"
        style={{
          backgroundImage: `url(${me})`,
        }}
      >
        <h1 className="text-lg md:text-3xl lg:text-4xl font-bold leading-snug text-left">
          Let go of what weighs you down <br />{" "}
          <span className="sm:pl-4">with Park Slope Colonics</span>
        </h1>
      </div>
    </section>
